  ...
  return (
    <header className=''>
      <div className='flex justify-between sm:justify-around items-center w-full h-[7em] bg-[#212021] py-12 font-marvel'>
        ...
        <form className='sm:flex w-[40%] sm:gap-10 hidden'>
          <input
            className='border-2 border-[#ed1c24] rounded-md w-[50%] h-10 cursor-pointer'
            type='text'
            id='search'
            name='search'
          />
      ...
      <Slider {...settings}>
        <div className='h-64 bg-blue-500 flex justify-center items-center sm:h-80'>
          <img
            className='static object-cover w-full h-full'
            src='../../public/1.jpg'
          />
        </div>
        <div className='h-64 bg-green-500 flex justify-center items-center sm:h-80'>
          <img
            className='static object-cover w-full h-full'
            src='../../public/4.jpg'
          />
        </div>
        <div className='h-64 bg-yellow-500 flex justify-center items-center sm:h-80'>
          <img
            className='static object-cover w-full h-full'
            src='../../public/5.jpg'
          />
      ...
      <nav className='hidden sm:block sm:font-marvel sm:text-[3em] sm:w-full sm:mt-10'>
        <ul className='flex justify-center gap-24'>
          <li className='relative cursor-pointer'>
            <a className='after:absolute after:content after:left-0 after:botton-0 after:block after:w-0 after:bg-red-900 after:h-[5px] after:transition-all hover:after:w-full after:duration-900ms after:ease-out'>
              Comics
            </a>
          </li>
          <li className='relative cursor-pointer'>
